...
import { FiChevronLeft, FiFileText, FiChevronDown, FiChevronRight } from 'react-icons/fi';
        ...
        documents: [
          {
            ...
            "path": "C:\\Users\\user\\Desktop\\Tasks\\Durbeen\\ReferenceBooks\\classroom_assessment\\chapter_mds\chapter9_record_keeping_tracking_student_learning.md",
            "source": "Classroom Assessment for Student Learning Jan Chappuis et al. Second Edition",
          ...
          },
          {
            ...
            "path": "C:\\Users\\user\\Desktop\\Tasks\\Durbeen\\ReferenceBooks\\classroom_assessment\\chapter_mds\chapter11_learning_targets.md",
            "source": "Classroom Assessment for Student Learning Jan Chappuis et al. Second Edition",
          ...
          },
          {
            ...
            "path": "C:\\Users\\user\\Desktop\\Tasks\Durbeen\\ResearchArticles\\research_mds\\Ongoing issues in test fairness.md",
      ...
      },
      {
        ...
        documents: [
          ...
          },
          {
            ...
            "path": "C:\\Users\\user\Desktop\\Tasks\\Durbeen\\ResearchArticles\\research_mds\\Deficiency, Contamination, and the Signal Processing Metaphor.md",
            ...
            <div className="opened-doc-full">
              ...
              <div style={{ marginTop: '5px' }}>
                <div className="doc-content">
                  <ReactMarkdown remarkPlugins={[remarkGfm]}>{openedDoc.content}</ReactMarkdown>
                </div>
              </div>
            </div>
          ) : (
                        ...
                        {module.documents.map((doc, docIdx) => (
                          <div key={docIdx} className="document">
                            ...
                            <input
                              ...
                              checked={selectedDocs.some(d => d.uniqueId === `${module.name}-${doc.id}`)}
                              onChange={() => handleCheckboxChange({ ...doc, uniqueId: `${module.name}-${doc.id}` })}
