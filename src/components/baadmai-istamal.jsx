        ...
        <div className="flex flex-col h-full p-3 gap-2 overflow-y-auto">
          ...
          {cardData.modules.map((module, idx) => {
            ...
            return (
              <div
                key={idx}
                className="w-full group hover:bg-gray-100 p-2 rounded font-semibold transition-colors"
              >
                {/* Module Header */}
                <div
                ...
                >
                  ...
                  <TooltipWrapper content={module.name}>
                    <span className="truncate max-w-[140px] text-sm text-gray-700">
                      {module.name}
                    </span>
                  </TooltipWrapper>
                </div>

                {/* Documents when module is open */}
                    ...
                    {module.documents.map((doc, docIdx) => (
                      ...
                      >
                        ...
                        <TooltipWrapper content={doc.name}>
                          <span
                            className="truncate max-w-[100px] text-sm text-gray-800 group-hover:underline"
                            onClick={(e) => {
                              e.stopPropagation();
                              openDocument(doc);
                            }}
